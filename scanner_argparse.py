...
class input_parser:
    ...
    def commandline_parse(self):
        ...
        parser.add_argument('-V','--Verbose',default=False,action='store_true',help='Very verbose output, only for the truly nerdy.')
        ...
        parser.add_argument('-a','--ack',default=False,action='store_true',help='Changes scan type to "ACK" (Defalts to SYN otherwise). This can help denote whether a firewall is filtered or not.')
